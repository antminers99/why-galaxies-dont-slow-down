...
- `artifacts/galaxy-analyzer/src/pages/validation.tsx` — Validation Pipeline: 7 statistical tests (permutation shuffle, bootstrap 1000×, jackknife leave-one-out, partial correlations, model comparison AIC/BIC, train/test 70/30, 5-fold CV), by-mass/quality/region breakdowns, final verdict with "What We Can Claim" and "Remaining Caveats"
