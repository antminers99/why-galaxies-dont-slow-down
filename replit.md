...
- `artifacts/galaxy-analyzer/src/pages/stress-test.tsx` — Stress Test: galaxy categories (dwarf/small/medium/massive), inner vs outer regions, outlier analysis, correction factor search, summary
