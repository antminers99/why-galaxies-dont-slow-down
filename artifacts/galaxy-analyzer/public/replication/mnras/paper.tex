...
We do not claim final identification of the fundamental physics, but we do claim a robust identification of the hidden state's direct observational carrier --- the outer-halo $\mtwo$ velocity-field mode ($\sim$95~per~cent confidence) --- and a strong narrowing of its physical interpretation toward a triaxial or closely related halo-shape state ($\sim$90~per~cent confidence), pending confirmation with larger multi-survey 2D samples.
...
Cross-survey replication with MaNGA, CALIFA, or PHANGS is essential before the carrier identification can be considered definitive.
...
Definitive confirmation requires an expanded 2D sample ($N \geq 20$) spanning multiple surveys (THINGS, MaNGA, CALIFA, PHANGS) to break the single-survey dependence and eliminate small-$N$ concerns.
