...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/fig1-bilateral-coupling}
\caption{Bilateral coupling in the $\vfresid$--$\aresid$ plane ($r = 0.77$, LOO, $N = 45$). Blue points show the full SPARC sample; red circles mark the seven THINGS galaxies with 2D velocity field data. The dashed line is the OLS fit. The systematic underpopulation of Q4 (the `dark quadrant') reflects the $4{:}1$ asymmetry of $H$.}
\label{fig:bilateral}
\end{figure}

\subsection{Geometric structure}

In the $\vfresid$--$\aresid$ plane (Fig.~\ref{fig:bilateral}), $H$ creates a characteristic asymmetry: the fourth quadrant (negative $\vfresid$, positive $\aresid$) is systematically underpopulated.
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/fig2-information-ceiling}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/fig3-dq-m2-power}
...
NGC~2841 ($\DQ = +2.25$, high bilateral excess) and NGC~5055 ($\DQ = -1.52$, low bilateral excess) form a structurally matched pair: $\Delta\log M_\mathrm{bar} = 0.07$, $\Delta\log\vflat = 0.09$ (Fig.~\ref{fig:goldpair}).
Despite this similarity, their outer-halo $\mtwo$ powers differ by a factor of $10.5\times$ --- consistent with $H$ tracing angular structure in the halo potential.

\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/fig4-gold-pair}
\caption{Property comparison of the gold pair: NGC~2841 (high bilateral excess) and NGC~5055 (low bilateral excess). Despite closely matched baryonic mass ($\Delta\log M_\mathrm{bar} = 0.07$), the outer-halo $\mtwo$ power differs by $10.5\times$, consistent with halo angular structure --- not baryonic properties --- driving the bilateral coupling.}
\label{fig:goldpair}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/fig6-red-team}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{figures/fig5-causal-chain}
...
The hidden common-cause state $H$ is real: the bilateral coupling is robust ($r = 0.77$, LOO, $N = 45$, replicated on $N = 59$ independent galaxies).
...
\begin{enumerate}
\item The hidden common-cause state $H$ is real: per-galaxy $\azero$ varies systematically, driven by $H$ through a bilateral coupling at $r = 0.77$ (LOO, $p < 0.001$, $N = 45$, replicated on $N = 59$ independent galaxies).
