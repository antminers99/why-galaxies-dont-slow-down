...
Analysis of 175 SPARC galaxy rotation curves reveals a hidden common-cause state $H$ that drives a bilateral coupling between flat-velocity residuals ($\mathrm{VfResid}$) and acceleration-scale residuals ($\mathrm{a0Resid}$) at $r = 0.77$ (LOO, $p < 0.001$, $N = 45$).
...
A10 & NGC~0891 & $-0.89$ & 216 & 9.9 & $+42^\circ$ & VLA \\
\bottomrule
\end{tabular}
\end{center}
