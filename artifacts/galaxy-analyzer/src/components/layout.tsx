...
import { Upload, Activity, FlaskConical, LayoutDashboard, Atom, Microscope, TrendingUp, BookOpen, Shield, Crosshair, ShieldCheck, Sparkles, TestTube2, Eye, Link2 } from 'lucide-react';
